      ...
      <main className="flex-1">
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-2xl font-bold text-center mb-10" style={{ color: "#801A28" }}>Jak rezervace funguje</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {JAK.map((k) => (
                <div key={k.krok} className="flex flex-col gap-3">
                  <div className="w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-sm shrink-0" style={{ backgroundColor: "#801A28" }}>
                    {k.krok}
                  </div>
        ...
        <section className="py-16 px-4" style={{ backgroundColor: "#F2EDE4" }}>
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-center mb-2" style={{ color: "#801A28" }}>Ceník — Olomouc</h2>
