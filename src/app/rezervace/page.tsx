...
const JAK_TO_FUNGUJE = [
  {
    krok: "1",
    nadpis: "Vyberte datum a délku",
    popis: "Ráno, odpoledne nebo večer — vyberete den, délku hry (60–120 min) a část dne.",
  },
  {
    krok: "2",
    nadpis: "Zvolte volný slot",
    popis: "Systém zobrazí všechny dostupné časy. Jeden kliknutím zarezervujete.",
  },
  {
    krok: "3",
    nadpis: "Zaplaťte online",
    popis: "Platba kartou nebo kreditem. Potvrzení přijde e-mailem okamžitě.",
  },
  {
    krok: "4",
    nadpis: "Přijďte hrát",
    popis: "Kurty jsou otevřené 7:00–23:00 každý den. Přijďte a hrajte.",
  },
];
      ...
      <main className="flex-1">
        ...
        <section className="py-20 px-4 text-center" style={{ background: "linear-gradient(135deg, #F2EDE4 0%, #fff 60%, #F2EDE4 100%)" }}>
          <span className="inline-block rounded-full px-4 py-1 text-sm font-medium mb-6" style={{ backgroundColor: "#F2EDE4", color: "#801A28" }}>
            Spouštíme v říjnu 2026
          </span>
          <h1 className="text-4xl font-extrabold tracking-tight mb-4" style={{ color: "#0A0A0A" }}>
            Online rezervace kurtů
          </h1>
          <p className="text-xl max-w-xl mx-auto mb-8" style={{ color: "#6b7280" }}>
            Rezervační systém spustíme spolu s otevřením první haly v Olomouci.
            Zanechte e-mail a budete první, kdo si zahraje.
          </p>
          <Link
            href="/kontakt"
        ...
        <section className="py-16 px-4" style={{ backgroundColor: "#F2EDE4" }}>
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-center mb-2" style={{ color: "#0A0A0A" }}>
              Ceník — Olomouc
            </h2>
            <p className="text-center text-sm mb-8" style={{ color: "#6b7280" }}>
              Cena je za kurt za hodinu, bez ohledu na počet hráčů.
            </p>
            <div className="rounded-2xl overflow-hidden border border-zinc-200 bg-white">
              <table className="w-full text-sm">
                <thead>
                  <tr style={{ backgroundColor: "#801A28", color: "#fff" }}>
                ...
                <tbody>
                  {CENIK.map((r, i) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-right font-semibold" style={{ color: "#801A28" }}>{r.cena}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <p className="text-xs text-center mt-4" style={{ color: "#9ca3af" }}>
              Přechází-li rezervace přes více cenových pásem, každá půlhodina se počítá dle svého pásma.
              Otevírací doba: každý den 7:00–23:00.
            </p>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="rounded-2xl border border-zinc-100 p-6">
                ...
                <p className="text-sm leading-relaxed" style={{ color: "#6b7280" }}>
                  Rezervaci lze zrušit nebo přesunout. Zaplacená částka se vrátí do kreditu.
                </p>
              </div>
              <div className="rounded-2xl border border-zinc-100 p-6">
                <div className="text-3xl mb-3">❌</div>
                ...
                <p className="text-sm leading-relaxed" style={{ color: "#6b7280" }}>
                  Zrušení ani přesun není možný. Nevyužitá rezervace propadá.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 px-4 text-white text-center" style={{ backgroundColor: "#801A28" }}>
          ...
          <p className="mb-8 max-w-md mx-auto" style={{ color: "#f3c6ce" }}>
            Rezervace spouštíme v říjnu 2026 v Olomouci. Nechte nám e-mail a dáme vám vědět.
          </p>
          <Link
            href="/kontakt"
